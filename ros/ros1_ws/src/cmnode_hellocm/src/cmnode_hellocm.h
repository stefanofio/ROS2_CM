...
#ifndef CMNODE_HELLOCM_H
#define CMNODE_HELLOCM_H
...
class CMNodeHelloCM : public CarMakerROSInterface {
 ...
 private:
   ...
   */
  void ext2cmCallback(const hellocm_msgs::Ext2CM::ConstPtr& msg);
   ...
   */
  void cm2extFillMsg(hellocm_msgs::CM2Ext::Ptr& msg);
