  ...
  std::ostream & out)
{
  ...
  {
    out << "synthdelay: ";
    rosidl_generator_traits::value_to_yaml(msg.synthdelay, out);
  }
  out << "}";
...
inline std::string to_yaml(const CM2Ext & msg, bool use_flow_style = false)
{
...
inline void to_yaml(
  const hellocm_msgs::msg::CM2Ext & msg,
  std::ostream & out, size_t indentation = 0)
{
...
inline std::string to_yaml(const hellocm_msgs::msg::CM2Ext & msg)
{
