...
static const _Ext2CM_type_support_symbol_names_t _Ext2CM_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, hellocm_msgs, msg, Ext2CM)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, hellocm_msgs, msg, Ext2CM)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, hellocm_msgs, msg, Ext2CM)() {
  return &::hellocm_msgs::msg::rosidl_typesupport_c::Ext2CM_message_type_support_handle;
}
