...
#include "hellocm_msgs/srv/detail/init__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const hellocm_msgs::srv::Init_Request & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  hellocm_msgs::srv::Init_Request & ros_message)
{
  // Member: message
  cdr >> ros_message.message;
...
{
  auto typed_message =
    static_cast<const hellocm_msgs::srv::Init_Request *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<hellocm_msgs::srv::Init_Request *>(
    untyped_ros_message);
...
{
  return &hellocm_msgs::srv::typesupport_fastrtps_cpp::_Init_Request__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, hellocm_msgs, srv, Init_Request)() {
  return &hellocm_msgs::srv::typesupport_fastrtps_cpp::_Init_Request__handle;
}
...
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_hellocm_msgs
cdr_serialize(
  const hellocm_msgs::srv::Init_Response & ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  // Member: success
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  hellocm_msgs::srv::Init_Response & ros_message)
{
  // Member: success
  {
    uint8_t tmp;
...
{
  auto typed_message =
    static_cast<const hellocm_msgs::srv::Init_Response *>(
    untyped_ros_message);
  return cdr_serialize(*typed_message, cdr);
}
...
{
  auto typed_message =
    static_cast<hellocm_msgs::srv::Init_Response *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}
...
{
  return &hellocm_msgs::srv::typesupport_fastrtps_cpp::_Init_Response__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, hellocm_msgs, srv, Init_Response)() {
  return &hellocm_msgs::srv::typesupport_fastrtps_cpp::_Init_Response__handle;
}
...
{
  return &hellocm_msgs::srv::typesupport_fastrtps_cpp::_Init__handle;
}
...
const rosidl_service_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, hellocm_msgs, srv, Init)() {
  return &hellocm_msgs::srv::typesupport_fastrtps_cpp::_Init__handle;
}
