...
bool hellocm_msgs__msg__cm2_ext__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("hellocm_msgs.msg._cm2_ext.CM2Ext", full_classname_dest, 32) == 0);
  }
  hellocm_msgs__msg__CM2Ext * ros_message = _ros_message;
  {  // header
...
{
  /* NOTE(esteve): Call constructor of CM2Ext */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("hellocm_msgs.msg._cm2_ext");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "CM2Ext");
