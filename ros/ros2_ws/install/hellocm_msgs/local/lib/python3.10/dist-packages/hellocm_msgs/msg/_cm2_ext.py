...
class Metaclass_CM2Ext(type):
    """Metaclass of message 'CM2Ext'."""
    ...
    def __import_type_support__(cls):
        try:
            ...
            logger = logging.getLogger(
                'hellocm_msgs.msg.CM2Ext')
            logger.debug(
                'Failed to import needed modules for type support:\n' +
                traceback.format_exc())
        else:
            cls._CREATE_ROS_MESSAGE = module.create_ros_message_msg__msg__cm2_ext
            cls._CONVERT_FROM_PY = module.convert_from_py_msg__msg__cm2_ext
            cls._CONVERT_TO_PY = module.convert_to_py_msg__msg__cm2_ext
            cls._TYPE_SUPPORT = module.type_support_msg__msg__cm2_ext
            cls._DESTROY_ROS_MESSAGE = module.destroy_ros_message_msg__msg__cm2_ext
...
class CM2Ext(metaclass=Metaclass_CM2Ext):
    """Message class 'CM2Ext'."""
    ...
    def synthdelay(self, value):
        if __debug__:
            ...
            assert not (value < -1.7976931348623157e+308 or value > 1.7976931348623157e+308) or math.isinf(value), \
                "The 'synthdelay' field must be a double in [-1.7976931348623157e+308, 1.7976931348623157e+308]"
